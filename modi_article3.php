...
<?php foreach($articles as $article): ?>
 ...
 <p class="card-header my-3"><?php 
		   ...
		   ?>
		      - Par  :<?php  echo  $table2->name;?>
			  <br>
		     - Categorie :  <?php echo $table3->name;?>
			 <br>
			 - Posté le  : <?= $article->date; ?> 
			</p>
							
                            
                           <a class="btn btn-warning" href="modi_article2_admin.php?id_article=<?= $article->id_article ?>" >Modifier</a>
