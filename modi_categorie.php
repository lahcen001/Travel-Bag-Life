...
$sql = 'SELECT * FROM article WHERE id_categories=:id_categories';
...
$statement = $connection->prepare($sql);
$statement->execute([':id_categories' => $id_categories ]);
$cat1 = $statement->fetchAll(PDO::FETCH_OBJ);
 ?>
      ...
      <div class="mask rgba-black-strong flex-center">
        <div class="container ">
          <div class="white-text text-center wow fadeInUp">
            ...
            <br>
			<?php foreach($cat1 as $cat2): ?>
            <h4> Categorie : <?= $cat2->name; ?> </h4>
			<?php endforeach; ?>
          </div>
        </div>
      </div>
...
<?php foreach($articles as $article): ?>
 ...
 <p class=" text-primary"> </p>
							...
							<a onclick="return confirm('Are you sure you want to delete this entry?')"  class="btn btn-danger"   href="trait_article\delete.php?id_article=<?= $article->id_article ?>" ><i class="fas fa-trash-alt"></i></a>
