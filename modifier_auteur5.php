...
<div class="card mt-3">
  <div class="card-body mt-3 mb-3 rounded">
		...
		<td><a type="button" class="btn btn-outline-info px-0" href="modifier_auteur4_admin.php?id_auteur=<?= $auteur->id_auteur ?>" >Modifier</a></td>
