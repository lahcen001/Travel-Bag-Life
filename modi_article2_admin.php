...
$fileError = $_FILES['image']['error'];
  ...
  if ($statement->execute([':titre_article' => $titre_article, ':image' => $fileName1, ':id_article' => $id_article, ':contenu_article' => $contenu_article, ':status' => $status])) {
...
if(isset($_SESSION["user"]) && $_SESSION["user"]["role"]== 1){
  ...
  <div class="card-body">
	   ...
	   <?php foreach($categories as $categorie): ?>
        ...
        <?php endforeach; ?>
    		    ...
    		    <div class="form-group">
    		        ...
    		        <textarea    name="contenu_article"   rows="5" class="form-control"  ><?= $table->contenu_article; ?></textarea>
    ...
    <select name="status"   class="form-control" id="exampleFormControlSelect1">
      ...
      <option value="1">inPublished</option>
...
<!--     		    
              ...
              <img class="card-img-top pt-3 w-25 img-fluid img-thumbnail  " src="trait_article\articles_image\<?= $table->image; ?>" alt="Card image cap">
